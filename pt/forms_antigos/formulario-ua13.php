...
?>
	...
	<h2> D - PATRIMÔNIO ARQUEOLÓGICO</h2>
	<h3> XIII - Patrimônio arqueológico indígena</h3>
	...
	<nav>
	  <ul class="pagination">
	    ...
	    <li class="disabled"><a href="formulario-ua7.php?museu=<?= $museu?>">7</a></li>
	    ...
	    <li class="active"><a href="formulario-ua13.php?museu=<?= $museu?>">13</a></li>
