...
?>
        <form class="form-horizontal" action="altera-museu.php" method="post">
          ...
          <div class="form-group">
            <label for="uf" class="col-sm-2 control-label">Distrito:</label>
            <div class="col-sm-10">
          ...
          <div class="form-group" id="listar_cidades">
            <label for="cod_cidade" class="col-sm-2 control-label">Concelho:</label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label for="endereco" class="col-sm-2 control-label">Morada</label>
            <div class="col-sm-10">
